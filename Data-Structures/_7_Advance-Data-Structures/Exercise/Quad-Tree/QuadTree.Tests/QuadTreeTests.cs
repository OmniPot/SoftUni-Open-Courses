...
namespace QuadTree.Tests
{
    ...
    public class QuadTreeTests
    {
        ...
        static List<TestBox> PerformCollisionSearchList(TestBox obj, List<TestBox> collisionCandidates)
        {
            ...
            Console.WriteLine(string.Join(", ", result.Select(c => c.Bounds)));
            return result;
        }

        static List<TestBox> PerformCollisionSearchQuadTree(TestBox obj, QuadTree<TestBox> quadTree)
        {
            var result = new List<TestBox>();
